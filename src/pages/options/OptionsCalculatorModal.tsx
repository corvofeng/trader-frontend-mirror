                    ...
                    <tr key={quote.strike} className={themes[theme].cardHover}>
                      ...
                      <td className={`px-3 py-3 text-center ${themes[theme].text}`}>
                        <button
                          ...
                          className={`px-3 py-2 rounded text-sm bg-green-500 text-white hover:bg-green-600 dark:bg-green-600 dark:hover:bg-green-700 font-medium transition-colors`}
                        >
                      ...
                      <td className={`px-3 py-3 text-center ${themes[theme].text} border-r ${themes[theme].border}`}>
                        <button
                          ...
                          className={`px-3 py-2 rounded text-sm bg-red-500 text-white hover:bg-red-600 dark:bg-red-600 dark:hover:bg-red-700 font-medium transition-colors`}
                        >
                          {formatCurrency(quote.callPrice, currencyConfig)}
                        </button>
                      </td>
