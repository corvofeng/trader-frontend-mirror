...
export interface OptionsService {
  ...
  updatePositions: (payload: { updates: Array<{ id?: string; type: 'call' | 'put'; position_type: 'buy' | 'sell'; strike: number; expiry: string; quantity: number; original_quantity?: number; change_quantity?: number }>, accountId?: string | null, userId?: string | null }) => Promise<ServiceResponse<{ updated: number }>>;
